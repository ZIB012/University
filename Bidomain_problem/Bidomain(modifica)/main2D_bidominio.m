...
if (Data.method == 'SI')
    ...
    for t=dt:dt:T
        ...
        % snapt = [0];
%         snapt = [0.002, 0.004, 0.006, 0.008, 0.010, 0.012, 0.014, 0.016, 0.018, 0.02, ...
%             0.022, 0.024, 0.026, 0.028, 0.334, 0.336, 0.338, 0.340, 0.342, 0.344, 0.346, ...
%             0.348, 0.350, 0.352, 0.354, 0.356, 0.360, 0.362, 0.364, 0.366, 0.368, 0.370, ...
%             0.372, 0.374, 0.376, 0.380, 0.382, 0.384, 0.386, 0.388, 0.390, ...
%             0.696, 0.698, 0.7, 0.702, 0.704, 0.706, 0.708, 0.71, 0.712, 0.714, ...
%             0.716, 0.718, 0.72, 0.722, 0.724, 0.726, 0.728, 0.73, 0.732, 0.734, 0.736, ...
%             0.738, 0.74, 0.742, 0.744, 0.746, 0.748, 0.75];
        if (Data.snapshot=='Y' && (mod(round(t/dt),Data.leap)==0))% && (t < 0.03 || t > 0.33)))
...
elseif (Data.method == 'OS')
    ...
    for t=dt:dt:T
        % metto la b in entrambe le matrici
...
%=========================================================================
 uh = u0_i-u0_e;
 [solutions]= postprocessing_Vm(femregion,Data,uh,T,timer);
