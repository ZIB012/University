...
elseif test=='Test5' % Test for wave front simulation (applied currents on the left side)
DATA = struct( 'name',          test,...
               ... % Test name
               'method',              'SI',...
               ... % Set time discretization (SI, OS, GO)
               ...
               'exact_sol_Vm',       '0.*x.*y',...
               ... % Definition of exact solution 
               'source_i',           '700*10^3*(t>=0.001 && t < 0.002).*(x<-0.0240)',...
               ... % Forcing term in time intracelluar            
               'source_e',           '700*10^3*(t>=0.001 && t < 0.002).*(x<-0.0240)',...    
               ... % Forcing term in time extracellular
               'Neumann_i',           '0.*x.*y',...
               ... % Boundary condition intracellular
               'Neumann_e',           '0.*x.*y',...
...
elseif test=='Test6' % Test for wave front simulation (applied currents on the left-down corner)
DATA = struct( 'name',          test,...
               ... % Test name
               'method',              'SI',...
               ... % Set time discretization (SI, OS, GO)
