...
elseif test=='Test4' % Test for wave front simulation (applied currents on the left side)
DATA = struct( 'name',          test,...
               ... % Test name
               'method',              'SI',...
               ... % Set time discretization (SI, OS, GO)
...
elseif test=='Test5' % Test for wave front simulation (applied currents on the left-down corner)
DATA = struct( 'name',          test,...
               ... % Test name
               'method',              'SI',...
               ... % Set time discretization (SI, OS, GO)
