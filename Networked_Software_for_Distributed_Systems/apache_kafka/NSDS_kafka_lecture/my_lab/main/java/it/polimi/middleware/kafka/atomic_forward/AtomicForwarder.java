    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            for (final ConsumerRecord<String, String> record : records) {
                ...
                if(mappa.containsKey(record.key()))
                {
                    mappa.replace(record.key(), mappa.get(record.key())+1);
                }
                else
                {
                    mappa.put(record.key(), 1);
                }
                /*
                 ...
                 */
                System.out.println("Key: " + record.key() + " number of time: " + mappa.get(record.key()));
